...
void * atendedor_de_alumno(void * params){
	...
	printf("Me quiero ir de este incendio! Soy el alumno %d\n", parametros->tid);
...
int main(void)
{
	...
	pthread_mutex_init(&mutex_salidas, NULL);
